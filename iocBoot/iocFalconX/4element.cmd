...
dbLoadDatabase("$(DXP_SITORO)/dbd/dxp.dbd")
...
< ../save_restore.cmd
save_restoreSet_status_prefix("dxpSITOR0:")
dbLoadRecords("$(AUTOSAVE)/asApp/Db/save_restoreStatus.db", "P=dxpSITORO:")
...
dbLoadRecords("$(ADCORE)/db/NDFileNetCDF.template","P=dxpSITORO:,R=netCDF1:,PORT=DXP1NetCDF,ADDR=0,TIMEOUT=1,NDARRAY_PORT=DXP1")
...
dbLoadRecords("$(SSCAN)/sscanApp/Db/scan.db","P=dxpSITORO:,MAXPTS1=2000,MAXPTS2=1000,MAXPTS3=10,MAXPTS4=10,MAXPTSH=2048")
...
create_monitor_set("auto_settings4.req", 30, "P=dxpSITORO:")

### Start the saveData task.
saveData_Init("saveData.req", "P=dxpSITORO:")
